            ...
            <main className="flex-1">
                ...
                <section className="relative overflow-hidden pt-24 pb-20 md:pt-32 md:pb-32 lg:pt-40 lg:pb-40">
                    ...
                    <div className="container flex flex-col items-center text-center gap-8">
                        ...
                        <h1 className="text-4xl font-extrabold tracking-tight sm:text-6xl md:text-7xl max-w-4xl bg-gradient-to-b from-foreground to-foreground/70 bg-clip-text text-transparent">
                        ...
                        <div className="mt-16 relative w-full max-w-5xl aspect-[16/9] bg-muted/20 rounded-xl border shadow-2xl overflow-hidden glass-card hidden md:block group">
